...
import me.fearlessdude.createbinary.item.ModCreativeModeTabs;
...
@Mod(CreateBinary.MOD_ID)
public class CreateBinary {

    // Define mod id in a common place for everything to reference
    public static final String MOD_ID = "createbinary";
    ...
    public static class ClientModEvents {
        ...
        public static void onClientSetup(FMLClientSetupEvent event) {
            event.enqueueWork(() -> {
                ItemBlockRenderTypes.setRenderLayer(ModBlocks.COMPUTERIZED_REDSTONE_LINK.get(), RenderType.cutout());
            });
        }
    }
}
